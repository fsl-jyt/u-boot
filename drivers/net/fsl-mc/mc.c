...
static int mc_copy_image(const char *title,
			 u64 image_addr, u32 image_size, u64 mc_ram_aligned_base_addr)
{
...
static int load_mc_aiop_img(u64 aiop_fw_addr)
{
	...
	mc_copy_image("MC AIOP image",
		...
		mc_ram_aligned_base_addr + CONFIG_SYS_LS_MC_DRAM_AIOP_IMG_OFFSET);
#endif
	mc_aiop_applied = 0;
...
int mc_apply_dpl(u64 mc_dpl_addr)
{
	...
	debug("In func %s mc_ram_aligned_base_addr=%llx\n",
		__func__, mc_ram_aligned_base_addr);
